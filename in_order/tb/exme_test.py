...
async def test(dut):
    ...
    for i in range(10000):
        val=[randint(0,1),randint(0,1),randint(0,3),randint(0,4294967295),randint(0,4294967295),randint(0,4294967295),randint(0,4294967295),randint(0,1),randint(0,7)]
        ...
        assert dut.funct3m.value==eval[8],f'wrong in the {i} iter'
